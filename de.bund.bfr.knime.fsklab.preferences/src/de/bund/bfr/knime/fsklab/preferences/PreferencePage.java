...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	protected void createFieldEditors() {
		...
		addField(new StringFieldEditor(PreferenceInitializer.PROXY_HOST_CFG, "Proxy host", parent));
		addField(new IntegerFieldEditor(PreferenceInitializer.PROXY_PORT_CFG, "Proxy port", parent));
	}
